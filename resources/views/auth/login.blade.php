...
<!--            <div class="alert alert-danger" role="alert">Username or Password Incorrect!</div>-->
            <form method="POST">
                ...
                <div class="form-group form-group-lg">
                    ...
                    <input name="userEmail" value="{{ old('userEmail') }}" type="email" class="form-control" id="exampleInputEmail1" placeholder="Email">
                </div>
                <div class="form-group form-group-lg">
...
<footer>
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                <a><h5 class="text-center">contact@bigdataexperience.org</h5></a>
                <h5 class="text-center">Call Michael <a>+66(0)9 8258 8261</a></h5>
            </div>
        </div>
    </div>
</footer>
